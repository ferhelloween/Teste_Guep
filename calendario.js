...
//******************************************************************************
	...
	var scwBaseYear = 1990;
    //var scwBaseYear        = 2004;

    // How many years do want to be valid and to show in the drop-down list?

    var scwDropDownYears   = ((scwDateNow.getFullYear() - 1990) + 1);
    //var scwDropDownYears   = ((scwDateNow.getFullYear() - 2004) + 1);

    // All language dependent changes can be made here...

    var scwToday               = 'Hoje:',
        scwDrag                = 'Clique aqui para mover o calend&aacute;rio',
        scwInvalidDateMsg      = 'Entre com uma data válida.\n',
        scwOutOfRangeMsg       = 'A data digitada está fora do padrão.',
        scwDoesNotExistMsg     = 'A data digitada não existe.',
        scwInvalidAlert        = ['Data inválida (',') ignorado.'],
        scwDateDisablingError  = ['Erro ',' não é um objeto DATA.'],
        scwRangeDisablingError = ['Erro ',' deve consistir de dois elementos.'],
        scwArrMonthNames       = ['Janeiro  ','Fevereiro','Mar&#231;o    ','Abril    ',
								  'Maio     ','Junho    ','Julho    ','Agosto   ',
								  'Setembro ','Outubro  ','Novembro ','Dezembro '],
		//scwArrMonthNames       = ['Jan','Fev','Mar','Abr','Mai','Jun','Jul','Ago','Set','Out','Nov','Dez'],
    ...
    var scwBackground           = '#DCDCDC';    // Calendar background
    ...
    var scwHighlightText        = '#000000',
        scwHighlightBackground  = '#FFA500';

    // Drag Handle
    var scwDragBackground       = '#E8E8E8',
		scwDragBorder			= '#FFFFFF',
        scwDragText             = '#A9A9A9';
    ...
    var scwWeekendText          = '#CC6666',
        scwWeekendBackground    = '#E8E8E8';

    // Days out of current month
    var scwExMonthText          = '#A9A9A9',
        scwExMonthBackground    = '#E8E8E8';

    // Current month's weekdays
    var scwCellText             = '#000000',
        scwCellBackground       = '#E8E8E8';

    // Input date
    var scwInDateText           = '#FFFFFF',
        scwInDateBackground     = '#8B8386';

    // Disabled days

    // Weekend Days
    var scwDisabledWeekendText          = '#CC6666',
        scwDisabledWeekendBackground    = '#CCCCCC';

    // Days out of current month
    var scwDisabledExMonthText          = '#A9A9A9',
        scwDisabledExMonthBackground    = '#CCCCCC';

    // Current month's weekdays
    var scwDisabledCellText             = '#000000',
        scwDisabledCellBackground       = '#CCCCCC';
    ...
    document.writeln(   '.scw       {padding:0px;vertical-align:middle;}');
    ...
    document.writeln(   'table.scw  {padding:0px;visibility:hidden;'           +
                                    ...
                                    ';border:ridge 2px;font-size:8pt;'        +
                                    'font-family:Verdana;'  +
                                    'font-weight:bold;}');
    document.writeln(   'td.scwDrag {text-align:center;font-size:7pt;' +
                                    'background-color:'  + scwDragBackground +
                                    ';padding:0px 0px;color:' + scwDragText  +
									';border: solid 1px ' + scwDragBorder +
                                    "}");
    ...
    document.writeln(   'input.scwHead  {height:16px;width:16px;'              +
    ...
    document.writeln(   'table.scwCells {text-align:right;font-size:7pt;'      +
...
// ****************************************************************************
	...
	//The function below calls the callendar adding the option to disabled the dates after
	function calendario(scwEle,scwSourceEle,scwblockDaysAfterToday) { 
		//The varible below told the program it needs to disabled the dates after
		//the current day.
		if (scwblockDaysAfterToday == true)
			scwDisabledDates[scwDisabledDates.length] = [new Date(scwDateNow.getFullYear(),parseInt(scwDateNow.getMonth()),(parseInt(scwDateNow.getDate()) + 1)),new Date(scwDateNow.getFullYear(),11,31)];
    ...
    function scwShow(scwEle,scwSourceEle,scwblockDaysAfterToday)
